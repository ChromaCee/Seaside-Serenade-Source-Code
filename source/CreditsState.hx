...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		['Seaside Serenade Team'],
		['ChromaCee',			'chromacee','AU Author\nProgrammer\nMain Artist/Animator\nComposer\nChart Revisionist',		'https://twitter.com/ChromaCee',		'0xFF4B1631'],
		['Akumu',				'akumu',	'Main Charter',													'https://twitter.com/river_oaken',		'0xFFE14680'],
		['AboArlok',			'aboarlok',	'Logo Designer',												'https://twitter.com/AboAlrokArt',		'0xFF6C1819'],
		[''],
		['Psych Engine Team'],
